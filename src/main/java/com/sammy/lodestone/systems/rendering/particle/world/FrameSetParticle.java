...
public class FrameSetParticle extends GenericParticle {
    ...
    public FrameSetParticle(ClientLevel world, WorldParticleEffect data, FabricSpriteProviderImpl spriteSet, double x, double y, double z, double xd, double yd, double zd) {
